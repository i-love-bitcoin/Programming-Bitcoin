...
class ECCTest(TestCase):
    ...
    def test_add(self):
        ...
        for x1, y1, x2, y2, x3, y3 in additions:
            x1_fe = FieldElement(x1, prime)
            y1_fe = FieldElement(y1, prime)
            x2_fe = FieldElement(x2, prime)
            y2_fe = FieldElement(y2, prime)
            x3_fe = FieldElement(x3, prime)
            y3_fe = FieldElement(y3, prime)
            p1 = Point(x1_fe, y1_fe, a, b)
            p2 = Point(x2_fe, y2_fe, a, b)
            p3 = Point(x3_fe, y3_fe, a, b)
